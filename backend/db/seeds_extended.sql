...
VALUES
    ...
    -- 10 clinicians (mixed DOCTOR and CLINICAL_SPECIALIST)
    ('90000000-0000-0000-0000-000000000101', 'doctor01@bloomcare.health',                  crypt('rash2003', gen_salt('bf')), 'Dr. Ayesha Perera',         'DOCTOR',              TRUE, FALSE, 'Obstetrics', '0779100101'),
    ('90000000-0000-0000-0000-000000000102', 'doctor02@bloomcare.health',                  crypt('rash2003', gen_salt('bf')), 'Dr. Malith Fernando',       'DOCTOR',              TRUE, FALSE, 'Maternal-Fetal Medicine', '0779100102'),
    ('90000000-0000-0000-0000-000000000103', 'doctor03@bloomcare.health',                  crypt('rash2003', gen_salt('bf')), 'Dr. Senuri Jayasinghe',     'DOCTOR',              TRUE, FALSE, 'Obstetrics', '0779100103'),
    ('90000000-0000-0000-0000-000000000104', 'doctor04@bloomcare.health',                  crypt('rash2003', gen_salt('bf')), 'Dr. Kavidu Silva',          'DOCTOR',              TRUE, FALSE, 'Endocrinology', '0779100104'),
    ('90000000-0000-0000-0000-000000000105', 'doctor05@bloomcare.health',                  crypt('rash2003', gen_salt('bf')), 'Dr. Rashmi Wijesuriya',     'DOCTOR',              TRUE, FALSE, 'Internal Medicine', '0779100105'),
    ('90000000-0000-0000-0000-000000000106', 'doctor06@bloomcare.health',                  crypt('rash2003', gen_salt('bf')), 'Dr. Tharindu Ekanayake',    'DOCTOR',              TRUE, FALSE, 'Obstetrics', '0779100106'),
    ('90000000-0000-0000-0000-000000000107', 'specialist01@bloomcare.health',              crypt('rash2003', gen_salt('bf')), 'Dr. Nethmi Abeykoon',       'CLINICAL_SPECIALIST', TRUE, FALSE, 'Cardiology', '0779100107'),
    ('90000000-0000-0000-0000-000000000108', 'specialist02@bloomcare.health',              crypt('rash2003', gen_salt('bf')), 'Dr. Lakshan Herath',        'CLINICAL_SPECIALIST', TRUE, FALSE, 'Nephrology', '0779100108'),
    ('90000000-0000-0000-0000-000000000109', 'specialist03@bloomcare.health',              crypt('rash2003', gen_salt('bf')), 'Dr. Imesha Ranasinghe',     'CLINICAL_SPECIALIST', TRUE, FALSE, 'Critical Care', '0779100109'),
    ('90000000-0000-0000-0000-000000000110', 'specialist04@bloomcare.health',              crypt('rash2003', gen_salt('bf')), 'Dr. Pahan de Mel',          'CLINICAL_SPECIALIST', TRUE, FALSE, 'Maternal-Fetal Medicine', '0779100110')
ON CONFLICT (email)
DO UPDATE SET
