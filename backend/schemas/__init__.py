...
from .appointment import (
    AppointmentCreate, AppointmentUpdate, AppointmentResponse, AppointmentActionResponse,
    SpecialistResponse, TimeSlot, AvailabilityResponse, AppointmentListResponse, SpecializationResponse
)
