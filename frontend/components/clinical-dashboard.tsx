        ...
        <aside className="w-80 bg-white border-r border-slate-200 flex flex-col">
          <div className="p-6 border-b border-slate-100">
            <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-slate-400 flex items-center gap-2 mb-4">
              ...
              {getText("Escalated Cases", "ඉහළ වූ අවදානම්", "உயர்ந்த ஆபத்து வழக்குகள்")}
            </h2>
            <div className="relative">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400" />
              <Input
                placeholder={getText("Search ID or Name...", "හැඳුනුම් අංකය හෝ නම...", "ஐடி அல்லது பெயர் தேடுங்கள்...")}
                value={searchQuery}
          ...
          <div className="p-3 border-b border-slate-100 flex items-center gap-2">
            <Button variant="outline" size="sm" className="flex-1 text-xs">
              ...
              {getText("Filter", "පෙරහන්", "வடிகட்டி")}
            </Button>
            <Button variant="outline" size="sm" className="flex-1 text-xs">
